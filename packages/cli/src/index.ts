...
/**
 * @minions-comms/cli — CLI for Minions comms
 *
...
import { customTypes } from '@minions-comms/sdk';
...
program.name('comms').description('Messages, threads, and notifications across all communication channels').version('0.1.0');

program.command('info').description('Show project info').action(() => {
    console.log(chalk.bold('Minions comms'));
    console.log(chalk.dim('Messages, threads, and notifications across all communication channels'));
    console.log('');
    console.log(`  SDK:    ${chalk.cyan('@minions-comms/sdk')}`);
    console.log(`  CLI:    ${chalk.cyan('@minions-comms/cli')}`);
    console.log(`  Python: ${chalk.cyan('minions_comms')}`);
