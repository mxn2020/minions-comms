# Manual Setup Steps for Minions Comms
...
Go to **GitHub → mxn2020/minions-comms → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-comms` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-comms-web`
- **GitHub repo**: `mxn2020/minions-comms`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `comms.minions.wtf`

### Documentation
- **Netlify site name**: `minions-comms-docs`
- **GitHub repo**: `mxn2020/minions-comms`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `comms.minions.help`

### Blog
- **Netlify site name**: `minions-comms-blog`
- **GitHub repo**: `mxn2020/minions-comms`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `comms.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `comms.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `comms.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `comms.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-comms/sdk`](https://www.npmjs.com/package/@minions-comms/sdk)
- CLI: [`@minions-comms/cli`](https://www.npmjs.com/package/@minions-comms/cli)
...
Your package: [`minions-comms`](https://pypi.org/project/minions-comms/)
...
| Item | Value |
|------|-------|
| Project | `minions-comms` |
| SDK (npm) | `@minions-comms/sdk` |
| CLI (npm) | `@minions-comms/cli` |
| Python (PyPI) | `minions-comms` |
| GitHub | `github.com/mxn2020/minions-comms` |
| Docs domain | `comms.minions.help` |
| Blog domain | `comms.minions.blog` |
| App domain | `comms.minions.wtf` |
